...
@section('content')
                ...
                <div class="col-lg-4 mb-5">
                    <div class="card border-0 bg-light shadow-sm pb-2">
                        ...
                        <div class="card-body text-center">
                            ...
                            <p class="card-text">Justo ea diam stet diam ipsum no sit, ipsum vero et et diam ipsum duo et no
                                et, ipsum ipsum erat duo amet clita duo</p>
                        </div>
                ...
                <div class="col-lg-4 mb-5">
                    <div class="card border-0 bg-light shadow-sm pb-2">
                        ...
                        <div class="card-body text-center">
                            ...
                            <p class="card-text">Justo ea diam stet diam ipsum no sit, ipsum vero et et diam ipsum duo et
    ...
    <div class="container-fluid pt-5">
        <div class="container pb-3">
            <div class="text-center pb-2">
                <p class="section-title px-5"><span class="px-2">Facilities </span></p>
                <h1 class="mb-4">Classes for Your Kids</h1>
            </div>
            <div class="row">
            ...
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <div class="d-flex justify-content-start mt-4">
                    <a class="btn btn-outline-primary rounded-circle text-center mr-2 px-0"
                        style="width: 38px; height: 38px;" href="#"><i class="fa fa-twitter"></i></a>
                    <a class="btn btn-outline-primary rounded-circle text-center mr-2 px-0"
